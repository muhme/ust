<!--
  ...
  hlu, Jan 5 2007 - $Date: 2008-03-09 15:04:49 +0100 (Sun, 09 Mar 2008) $
-->
...
Monat: 
<!-- dynamic include -->
<jsp:include page="<%= "MonthChoosen.jsp?withQuarters=true&selectValue=" + month %>" flush="true"></jsp:include>
<%
